...
function hocwp_ext_plugins_loaded_action() {
	load_plugin_textdomain( 'sb-core', false, basename( dirname( __FILE__ ) ) . '/languages' );
}

add_action( 'plugins_loaded', 'hocwp_ext_plugins_loaded_action' );