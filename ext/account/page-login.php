...
<div id="loginFormContainer" class="account-login">
    <form id="loginForm" class="login-form maxw-600 mx-auto clearfix border rounded pd-20 info" action="" method="post">
		<?php
        ...
        <div class="form-group row mb-15">
            <div class="<?php echo $class; ?>">
                <label for="user_login"><?php _e( 'Username or Email', 'sb-core' ); ?> <span
                            class="required">*</span></label>
            </div>
            <div class="<?php echo $sub_class; ?>">
                <input name="user_login" id="user_login" class="required input form-control" type="text"
                       autocomplete="username" required
                       placeholder="<?php esc_attr_e( 'Enter username or email', 'sb-core' ); ?>">
            </div>
        </div>
        <div class="form-group row mb-15">
            <div class="<?php echo $class; ?>">
                <label for="user_pass"><?php _e( 'Password', 'sb-core' ); ?> <span class="required">*</span></label>
            </div>
            <div class="<?php echo $sub_class; ?>">
